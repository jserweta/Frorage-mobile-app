...
class AddProductToBuyFragment(
    ...
    override fun onCreateView(inflater: LayoutInflater,
        ...
        btnBack.setOnClickListener {
            val fragment = ShoppingListFragment(mCtx)
        ...
        btnAddProduct.setOnClickListener{
            ...
            if(productNameText.isNotEmpty()) {
                ...
                addProduct(header, Model.FullProduct(kitchenId, productNameText, amountText, unitText, toBuy = true, favourite = false, runningOut = false, expirationDate = null))
                }
        }
